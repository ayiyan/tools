...
class MyAnsiable2(object):
    ...
    def __init__(self,
        ...
        # 变量管理器
        # VariableManager.extra_vars = {'inventory_dir':'/opt/Auto/config/iaas_test_cases/nfvt_func/'}
        self.options = {
            'inventory_dir': '<inventory_dir>',
            'prefix': '<prefix>'
        }
        self.variable_manager = VariableManager(self.loader, self.inv_obj,)
        self.variable_manager._extra_vars.update(self.options)
...
ansible3.playbook(playbooks=['/<playbook directory>/playbook.yml'])
